    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="assets/img/rino.jpg" alt="user" class="img-responsive center-box" style="max-width: 110px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Guarda los datos del animal puedes actualizar la información actual, o eliminar el registro completamente y añadir uno nuevo.
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-green">Guardar datos del animal</div>
                <form name="forml"  method="post" action="insertar_especie.php">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="numid"placeholder="Num id" required="" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="10" data-toggle="tooltip" data-placement="top" title="id">
                            ...
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="nombrezoo"placeholder="Nombre del zoologico" required="" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Nombre del zoologico">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Nombre del zoologico</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="nombreespecie"placeholder="Nombre de la especie" required="" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Nombre de la especie">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Nombre de la especie</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="sexo"placeholder="Sexo" required="" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Sexo del animal">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Sexo</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="pais"placeholder="Pais" required="" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Pais del animal">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Pais</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="continente"placeholder="Continente" required="" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Continente donde es el animal">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                   ...
                   <th scope="row"><?php echo $fila["numid"]?></th>
                   <td><?php echo $fila["nombrezoo"]?></td>
                  <td><?php echo $fila["nombreespecie"]?></td>
        ...
        <p class="text-center">
            <a title="pdf" href="app/reportes/reportes.php"> <img src="assets/img/pdf.png" alt="pdf" class=" footer-social"  style="max-width: 70px;" ></a>
        </p>
